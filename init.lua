...
vim.keymap.set("n", "<leader>sf", function() fzf_lua.files({ resume = true }) end, { desc = "Find file" })
vim.keymap.set("n", "<leader>sr", function() fzf_lua.git_files({ resume = true }) end, { desc = "Find file" })
vim.keymap.set("n", "<leader>sg", function() fzf_lua.live_grep() end, { desc = "Live grep" })
...
local function setup_luals_lsp()
    vim.lsp.start({
        ...
        filetypes = { 'lua' },
        root_dir = find_root({ '.luarc.json', '.luarc.jsonc', '.luacheckrc', '.stylua.toml', 'stylua.toml', 'selene.toml',
            'selene.yml', '.git' }),
        root_markers = find_root({ '.luarc.json', '.luarc.jsonc', '.luacheckrc', '.stylua.toml', 'stylua.toml',
...
vim.api.nvim_create_autocmd('LspAttach', {
    callback = function(event)
        ...
        vim.keymap.set('n', '<leader>sw', fzf_lua.lsp_workspace_symbols, opts)
        vim.keymap.set('n', '<leader>ss', fzf_lua.lsp_document_symbols, opts)
        ...
        vim.keymap.set('n', '<leader>sd', fzf_lua.lsp_document_diagnostics, opts)
    end,
})
